...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "/home/eagles/Work/ts-framework",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
var User = function () {
  function User(data) {
    ...
    this.events = new Eventing_1.Eventing(); // problem with this technique is that it is hard coded and we cannot swap out sub modules easily.
  }
